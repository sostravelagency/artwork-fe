...
import { UserOutlined, FileTextOutlined, ShoppingCartOutlined, SolutionOutlined } from '@ant-design/icons';
...
const Sidebar = () => {
  ...
  const onClick = (e) => {
    ...
    if(e.key=== "manage-report-users") {
        window.location.href= window.location.origin + "/admin/tablerpuser"
